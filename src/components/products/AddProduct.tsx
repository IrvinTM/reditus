      ...
      <form>
        ...
        <DialogContent className="w-[80%] h-[90%] overflow-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Agrega los detalles del producto y presiona guardar.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4">
            ...
            <div className="grid gap-3">
              ...
              <Input
                ...
                defaultValue={prod.measurementUnit}
              />
            </div>
            <div className="grid gap-3">
            ...
            <div className="grid gap-3">
              ...
              <Input
                ...
                onChange={handleChange}
                name="cost"
                defaultValue={prod.cost}
                type="number"
              />
            </div>
            <div className="grid gap-3">
              <Label htmlFor="no-tax-included-price">
                Precio sin impuestos
              </Label>
              <Input
                id="no-tax-included-price"
                onChange={handleChange}
                name="noTaxIncludedPrice"
                defaultValue={prod.noTaxIncludedPrice}
                type="number"
              />
            </div>
            <div className="grid gap-3">
              ...
              <Input
                id="tax-included-price"
                onChange={handleChange}
                name="taxIncludedPrice"
                defaultValue={prod.taxIncludedPrice}
                type="number"
              />
            </div>
            <div className="grid gap-3">
              ...
              <Input
                ...
                defaultValue={prod.profitMargin}
                type="number"
              />
            </div>
            <div className="grid gap-3">
